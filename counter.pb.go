...
const file_counter_proto_rawDesc = "" +
	"\n" +
	"\rcounter.proto\x12\x04main\"\x12\n" +
	"\x10IncrementRequest\")\n" +
	"\x11IncrementResponse\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x05R\x05valueB\bZ\x06.;mainb\x06proto3"
...
var file_counter_proto_goTypes = []any{
	(*IncrementRequest)(nil),  // 0: main.IncrementRequest
	(*IncrementResponse)(nil), // 1: main.IncrementResponse
}
